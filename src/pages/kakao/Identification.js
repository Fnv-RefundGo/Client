    ...
    return (
        <div>
            ...
            <a className="kakao-loginBtn"
               href="https://kauth.kakao.com/oauth/authorize?client_id=88f077af67004ade2b18e854877842f6&redirect_uri=http://localhost:8000/api/v1/oauth2/kakao&response_type=code">
